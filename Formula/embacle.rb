...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "ab5f7dd3db95805db78613ba7d515ac3932030fb44074edab55c59f540d75b23"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "a43f29c2bdfbf9b8855e7758ce529b43f09f55930ea051bb8412c59d4ba75053"
    end
  end
  ...
  on_linux do
    ...
    sha256 "ca0a7cb5df1f9d7577f52c03a6c47eb1080e6fbd18c1ba3141f60ad742795b6e"
  end
