...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "b29dcf312f73e1a74237bd562c7ed33f0ac91dcb4c9c809a6e687faa1180c938"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "30a880b7d11c9f3bbbff705508a03020d42619d7fabe3850a9e97c773468d31e"
    end
  end
  ...
  on_linux do
    ...
    sha256 "3ddf7ce9400b698336d88fc06b11fa9ca8805d13110d880855ed9b1b403e98ba"
  end
