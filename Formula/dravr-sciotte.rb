...
class DravrSciotte < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "4eb2073c84e58a1a06888d7bf96991f7efd583aa7ed0ee343347034046370287"
    else
      ...
      sha256 "9116417c6d1c80204cf80b49cae191b8eedb2af7c56aa11e0116f2cccf2c4f57"
    end
  end
  ...
  on_linux do
    ...
    sha256 "ecf5ac759bd8016cf65e65eaee80a6da298f00de3cab9a2891a90f9e22c3ce91"
  end
