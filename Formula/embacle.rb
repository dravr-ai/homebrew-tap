...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "146232868bd39e6aa65ab94a04d141aa0c03721c7f8cbc860536b2168528e6da"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "1b765ee3a0958c249bdbcb18f46a92d63f265bd69686d347378620b62e926f5b"
    end
  end
  ...
  on_linux do
    ...
    sha256 "05e1bec09c2b3316a1e95badde97789cfcd4dadb292fd5deb9c52a0bbc09d3dd"
  end
