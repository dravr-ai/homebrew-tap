...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "fc3fc69bda5329b7394f2e72966f207f89a757a282472c10dd16f9be91e89a83"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "0c21d1c3e9ef0530a60f41b9097a17a1a2e5026aca25fe374badb017eaafed4b"
    end
  end
  ...
  on_linux do
    ...
    sha256 "e5a1773e7b250f0cd827099c19f7fb60bff40e6650d10850584f086b6af0e0be"
  end
