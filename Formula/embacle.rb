...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "6ab71c6c09df36b793627874b42f75872fc83b9f0f78a5c84b22e4ebf682a891"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "13d285f679fd43f695edff2e00eca266a63a91dcf3b2a995e5c2cfbec31cec7f"
    end
  end
  ...
  on_linux do
    ...
    sha256 "6a8dea4d29419757920c5a21776799980986b92264d1ecedb58a2e6ca8764cd8"
  end
