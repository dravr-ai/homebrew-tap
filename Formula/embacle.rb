...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "5e635c71d820c0b66e0e51a5ac09f38bbf069848a0a265fb9c8477c3e66a37ee"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "7424f1c26e0c3b84422bbb5455f7fadf22264d1d01311b0d50954172aff9c9bf"
    end
  end
  ...
  on_linux do
    ...
    sha256 "d3ed22da5059fa4f2f08672eab771b80445c61c2d4be5ab4cc527ebe0fa4a222"
  end
