...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "0f50ed8efe5ac75015d5effbb5bbf6f123b0de8230d497f5f885ebed32adb03c"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "131c1fbbda01ed7264bf187e34745c3b0420b93051f761cd61d314940f4fd110"
    end
  end
  ...
  on_linux do
    ...
    sha256 "f79858da2391c0ffbd0e544286ea1a13286b2669bbb20d8c1a451932e2e60792"
  end
