...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "2e11369872b9341e498b46566e95455bab39f18889fef2372634c3e440b50088"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "7c11cc46b2fc16bcd1eebe13688ebd92f902e960db48ff543a29f51fccf38fb7"
    end
  end
  ...
  on_linux do
    ...
    sha256 "e67c74d9d2383ed6d64c72a9e0a1e0149e7184810136709ed6cf07a5eab02d8c"
  end
