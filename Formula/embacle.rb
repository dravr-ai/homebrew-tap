...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "120785b70eb9376e625fffee6142437998fd15f665db6dde4ce66a35c993825d"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "4e07ab59c8b740a97d04d9ca47c88213ceaaae7ed1ba196abfb85ca520ec32cc"
    end
  end
  ...
  on_linux do
    ...
    sha256 "b5d336afd5caea2060758be1ee6bf8e5377dc80c53624287dbc40b456271e507"
  end
