...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "f281e25ed011c6891c684e965d1bee6107b4f61ed629e68e756ab373d6767160"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "6ea70d6c203592e685f011e61bfe46949751506c2b97e440cedee4202c9896af"
    end
  end
  ...
  on_linux do
    ...
    sha256 "efdf89973b313fc33b6b7696c9666e1320728d44ce5da04a931cb61651d9b156"
  end
