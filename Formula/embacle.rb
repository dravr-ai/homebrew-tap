...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "9e68e6fb83af7324ba51de1fd7c254c2e4cae1a59e5817d01c9ad785ebc88099"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "73e2b90473f7ef425c0e29bd808c6ac73e091a822deb521525cf7bd7db044021"
    end
  end
  ...
  on_linux do
    ...
    sha256 "ca9703270a4efa93e99e44bd8b17d311ac0ca44dbba3dd822a71259ee0d9bb5c"
  end
