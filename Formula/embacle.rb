...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "449ee534ebdb6702e5f06c4456c9335b9046e08ebc412e679f98892af0ec2aa4"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "00a95929f39c1809b6d95f9fe2e20d5d37acf76f58d0c5616cc523be16ab00a7"
    end
  end
  ...
  on_linux do
    ...
    sha256 "b83a0b0df4f82f2221fe12410db9d0bebfcc5c1e18bf45c817616e246105882b"
  end
