...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "a73be15606be1d8fcc08fc322063f850da06faaeba85ca3c849576981ef79155"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "fabfc54f66b05e43b4325d4bb632b08d21b43a8795f3b640178fa5a7269746b2"
    end
  end
  ...
  on_linux do
    ...
    sha256 "0b6089a758cbce350961550020357cf83aa8ea6b7c15b34d88a7b80d7ab89b92"
  end
