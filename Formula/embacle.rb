...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "ea4cd4a39591254138d45ab142819c2743b7c232e1793442bbeb31d3edc37eca"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "151be69b8909c23ad720ef3ade44c6754207e6451eeae3fc634bd5f92238bcf5"
    end
  end
  ...
  on_linux do
    ...
    sha256 "1796a02fd6df0c7c479d2f5aa9550cfa7553306a2de30e92b695a4918c52393f"
  end
