...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "71a43fa376c518ea592736ac1a6fbf07627910e8c203d366173cfa637803341e"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "0925904ac12dd9a8c8a43a744fd68f2354d7a78a8517b9f42d28805b8b8a8fc9"
    end
  end
  ...
  on_linux do
    ...
    sha256 "ac4ee4d1191f688430b8a138a1dfb8fed99df9d8cd0f56b950407c5292d3213f"
  end
