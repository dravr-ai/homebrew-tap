...
class DravrCanot < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "3ea09a9a8535f12c2ddbb00a28830bca6f84c058463496ac83c6e198144edac4"
    else
      url "https://github.com/dravr-ai/dravr-canot/releases/download/v#{version}/dravr-canot-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "df027bbfbff27dda3f443454655db494f629aee4789a2ca63a34ba89b10326de"
    end
  end
  ...
  on_linux do
    ...
    sha256 "296f680749bc18a5ff12be48157c12a4fb3d9d4bde814426e10f2afa820fd441"
  end
