...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "7e9b5734970f1b21c505e76e5c60ab218e6ae450bb948607924719e60eed18ed"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "43c8422a0d3568276eb5e2644ed6f6db9e87bacc09895e6db55ffac5696b7c2e"
    end
  end
  ...
  on_linux do
    ...
    sha256 "831c73681a636c3539dedec23d66356d732e5779d7aae92afd70a21159662825"
  end
