...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "145893d8e82857a11686f79bfd2b3489418b4d4b7a2fd4d1dd76b8c069fa5d6a"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "03ed5535ff169da9be4e082e7618aea6429c31525dd68282cca5a8e5368cd41b"
    end
  end
  ...
  on_linux do
    ...
    sha256 "34cef7f04e17605ef304d43171c5109feda5f23adb4d29a53ea2aeb742059969"
  end
