...
class Embacle < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "7cd58a01db864e074faeaddab7ba1b115793ba50bd467b305975073d3b4c9442"
    else
      url "https://github.com/dravr-ai/dravr-embacle/releases/download/v#{version}/embacle-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "2eaff0756d1234da3ecfb5e6528253dc26e64ab918b5e8fb34f6f87c0bb7e0eb"
    end
  end
  ...
  on_linux do
    ...
    sha256 "7bb8e99f9f66d94f223125b70838d0867dd268ceae8b1621162c49b1958e8dd1"
  end
